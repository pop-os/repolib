...
from .. import file, util, source, system
...
class SourceTestCase(unittest.TestCase):
    def setUp(self): 
        ...
        self.source.file = file.SourceFile(name=self.source.ident)

        self.legacy_source = source.Source()
        self.source_legacy.ident = 'test-legacy'
        self.source_legacy.name = 'Test Legacy Source'
        self.source_legacy.enabled = True
        self.source_legacy.types = [util.SourceType.BINARY, util.SourceType.SOURCECODE]
    ...
    def test_default_source_data(self):
        ...
        self.assertEqual(self.source.file.name, 'test.sources')
    ...
    def test_output_822(self):
        ...
        self.assertEqual(self.source_legacy, legacy_source_string)
    ...
    def test_dict_access(self):
        ...
        self.assertEqual(self.source['Enabled'], 'yes')
        self.assertEqual(self.source['Types'], 'deb')
    ...
    def test_load(self):
        ...
        self.assertEqual(load_source.file.name, 'test.sources')
        ...
        self.assertEqual(load_legacy_source.file.name, 'test.sources')
    ...
    def test_save_load(self):
        ...
        self.assertEqual(load_source.file. self.source.file)
